...
void
ani_log_set_level(ani_log_level level)
{
	ani_log_current_level = level;
}

static void
ani_log_internal(ani_log_level level, const char *level_str, const char *fmt, va_list args)
{
