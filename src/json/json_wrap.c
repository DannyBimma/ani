...
ani_json_doc *
ani_json_parse(const char *json_str, size_t len)
{
	ani_json_doc *doc;
	yyjson_read_err err;
	...
	if (doc->doc == NULL) {
		LOG_ERROR("JSON parse error: %s (at position %zu)",
		          err.msg, err.pos);
		free(doc);
		return NULL;
	}
...
void
ani_json_doc_free(ani_json_doc *doc)
{
	if (doc == NULL) {
		return;
	}
...
ani_json_val *
ani_json_get_root(ani_json_doc *doc)
{
...
bool
ani_json_is_object(const ani_json_val *val)
{
	return val != NULL && val->val != NULL && yyjson_is_obj(val->val);
}

bool
ani_json_is_array(const ani_json_val *val)
{
	return val != NULL && val->val != NULL && yyjson_is_arr(val->val);
}

bool
ani_json_is_string(const ani_json_val *val)
{
	return val != NULL && val->val != NULL && yyjson_is_str(val->val);
}

bool
ani_json_is_int(const ani_json_val *val)
{
...
bool
ani_json_is_bool(const ani_json_val *val)
{
	return val != NULL && val->val != NULL && yyjson_is_bool(val->val);
}

bool
ani_json_is_null(const ani_json_val *val)
{
	return val == NULL || val->val == NULL || yyjson_is_null(val->val);
}

ani_json_val *
ani_json_object_get(const ani_json_val *obj, const char *key)
{
...
const char *
ani_json_object_get_string(const ani_json_val *obj, const char *key)
{
	ani_json_val *val;
...
long
ani_json_object_get_int(const ani_json_val *obj, const char *key, long default_val)
{
	ani_json_val *val;
...
bool
ani_json_object_get_bool(const ani_json_val *obj, const char *key, bool default_val)
{
	ani_json_val *val;
...
size_t
ani_json_array_size(const ani_json_val *arr)
{
...
ani_json_val *
ani_json_array_get(const ani_json_val *arr, size_t index)
{
	static struct ani_json_val result;
	yyjson_val *val;
...
const char *
ani_json_get_string(const ani_json_val *val)
{
...
long
ani_json_get_int(const ani_json_val *val)
{
...
bool
ani_json_get_bool(const ani_json_val *val)
{
...
const char *
ani_json_get_string_safe(const ani_json_val *val, const char *default_val)
{
	const char *str;
